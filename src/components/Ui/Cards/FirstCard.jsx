  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          शिवशक्ति{" "}
          <Text className="tiro-devanagari-hindi-regular" bgColor="transparent" as={"span"} color={"#333"}>
            कालका सनातन{" "}
          </Text>
          सेवा संस्था{" "}
        </Text>
        ...
        <Box bgColor="transparent" display={"flex"} justifyContent={"center"} flexDirection="row" gap={4}>
          <Button
            display={"flex"}
            alignItems={"center"}
            gap={3}
